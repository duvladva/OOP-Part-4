...
public class Main {
    public static void main(String[] args) {
        ...
        Car Lada = new Car("Lada", "Vesta", 1.7, driverB);
        Car Audi = new Car("Audi", "", 3.0, driverB);
        Car Bmv = new Car("BMV", "BMV Z8", 2.0, driverB);
        Car Hyundai = new Car("Hyundai", "Hyundai Avant", 1.6, driverB);

        Bus Daewoo = new Bus("Daewoo", "mod001", 3.0, driverD);
        Bus Mercedes = new Bus("Mercedes", "mod002", 2.8, driverD);
        Bus Paz = new Bus("PAZ", "mod003", 3.5, driverD);
        Bus LiAZ = new Bus("LiAZ", "5292", 3.2, driverD);

        Truck KamAZ = new Truck("KamAZ", "5320", 10.0, driverC);
        Truck MAZ = new Truck("MAZ", "5432", 11.0, driverC);
        Truck Volvo = new Truck("Volvo", "2012", 12.0, driverC);
        Truck DAF = new Truck("DAF", "105", 13.0, driverC);
